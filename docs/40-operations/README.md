...
- 发布前检查、产物范围、engineering release 与产品 GA 的区分、以及 Step 08 的 tag 约束请参考 [`release-prep.md`](./release-prep.md)。
...
- See [`release-prep.md`](./release-prep.md) for release-prep checks, artifact scope, the Step 08 tag constraint, and the distinction between engineering release and product GA.
