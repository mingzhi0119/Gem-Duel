...
- 发布前检查、产物范围、engineering release 与产品 GA 的区分、Step 08 的 tag 约束，以及当前 Desktop shared-shell artifact 形态请参考 [`release-prep.md`](./release-prep.md)。
...
- See [`release-prep.md`](./release-prep.md) for release-prep checks, artifact scope, the Step 08 tag constraint, the current Desktop shared-shell artifact shape, and the distinction between engineering release and product GA.
