...
- full-board roadmap 的 phase 落地日志请参考 [`logs/README.md`](./logs/README.md)，其中已包含 Phase 1 delayed addendum、Phase 2 closure、Phase 3 evidence caveat、Phase 4 completion evidence、Phase 5 parity closure、Phase 6 room-board convergence closure、Phase 7 replay/product-finish closure 与 Phase 8 desktop-offline closure。
