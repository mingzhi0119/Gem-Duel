...
- full-board roadmap 的 phase 落地日志请参考 [`logs/README.md`](./logs/README.md)，其中已包含 Phase 1 delayed addendum、Phase 2 closure 与 Phase 3 evidence caveat 入口。
...
- See [`logs/README.md`](./logs/README.md) for landing logs attached to roadmap phases, including the Phase 1 delayed addendum, Phase 2 closure, and Phase 3 evidence caveat.
